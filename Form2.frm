...
For i = 1 To NbFile
 ...
 Form1.Grille1.Row = i
 Form1.Grille1.Col = 1
 PathFile = Form1.Grille1.Text
 Form1.Grille1.Col = 0
 PathFile = PathFile & Form1.Grille1.Text
 Form1.Label3.Caption = "File : " & PathFile
 Open PathFile For Input As file1
  ...
  Do While Not EOF(file1) ' Loop until end of file.
    Line Input #file1, textline ' Read line into variable.
     If Form1.Check1.Value = 0 And InStr(1, textline, "_") <> 0 Then GoTo skip1
       If InStr(1, textline, "Public Sub") <> 0 Then
         Form1.AddFunctionSub Trim(textline), PathFile
     ...
     Form1.Label4.Caption = Form1.Grille2.Rows & " Functions/Subs Found."
skip1:
     DoEvents
   Loop
